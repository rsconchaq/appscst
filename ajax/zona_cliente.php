...
switch ($_GET["op"]) {
	...
	if (empty($id)) {
		$rspta=$zona->insertar($cliente_id,$nombre,$descripcion,$estado,$id_usuario_modifica,$fecha_modifica);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
	}else{
         $rspta=$zona->editar($id,$cliente_id,$nombre,$descripcion,$estado,$id_usuario_modifica,$fecha_modifica);
	...
	case 'desactivar':
		$rspta=$zona->desactivar($id);
		echo $rspta ? "Datos desactivados correctamente" : "No se pudo desactivar los datos";
		break;
	case 'activar':
		$rspta=$zona->activar($id);
		echo $rspta ? "Datos activados correctamente" : "No se pudo activar los datos";
		break;
	
	case 'mostrar':
		$rspta=$zona->mostrar($id);
