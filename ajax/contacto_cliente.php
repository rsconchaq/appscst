...
switch ($_GET["op"]) {
	...
	if (empty($id)) {
		$rspta=$contacto->insertar($cliente_id,$tipo_identificacion,$identificacion,$nombre,$direccion,$correo_electronico,$telefono,$estado,$id_usuario_modifica,$fecha_modifica);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
	}else{
         $rspta=$contacto->editar($id,$cliente_id,$tipo_identificacion,$identificacion,$nombre,$direccion,$correo_electronico,$telefono,$estado,$id_usuario_modifica,$fecha_modifica);
	...
	case 'desactivar':
		$rspta=$contacto->desactivar($id);
		echo $rspta ? "Datos desactivados correctamente" : "No se pudo desactivar los datos";
		break;
	case 'activar':
		$rspta=$contacto->activar($id);
		echo $rspta ? "Datos activados correctamente" : "No se pudo activar los datos";
		break;
	
	case 'mostrar':
		$rspta=$contacto->mostrar($id);
