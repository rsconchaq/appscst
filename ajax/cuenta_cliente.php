...
switch ($_GET["op"]) {
	...
	if (empty($id)) {
		$rspta=$cuenta->insertar($cliente_id,$descripcion,$estado,$id_usuario_modifica,$fecha_modifica);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
	}else{
         $rspta=$cuenta->editar($id,$cliente_id,$descripcion,$estado,$id_usuario_modifica,$fecha_modifica);
